...
print("\033[1;35m───────────────────────────────────────KHOF M4K3R ABHISHEK ───────────────────────────") 
print("\033[1;35m─────DABBANG KI BH3N KA PYAR ABHISHEK─────────────────────────────────────────────────────────────") 
print("\033[1;35m────────DABBANG KI BH3N S4NVI KA REP KRNE WALA ABHISHEK DON──────────────────────────────────────────────────────────") 
print("\033[1;35m────────────────DABBANG JOK3R KI BH3N KA SUHAG ABHISHEK  DON──────────────────────────────────────────────────") 
print("\033[1;35m──────────────────────────────────────────────────────────────────") 
print("\n                     \033[38;2;124;252;0mCreated By: UNB34T9BL3 BOII ABHISHEK INSID3")
print("-----------------------------------------------------------------------")
...
def main():
    ...
    logo()
    print('-------------------------------------------')
    print("\033[1;34m Note >>  DABBANG KII BH9N KA YAR ABHISHEK 0N FIR3")
    print('-------------------------------------------')
    coki = input(' [+] Cookies : ')
    cookies={'cookie': coki}
    ...
    if 'mbasic_logout_button' in ch.text:
        ...
        print(' \x1b[1;91mYeh Tu DABBANG ki maa ka boxda dal diya sai cookies dal 😹 !!! \x1b[1;97m')
        os.sys.exit()
    print(' \x1b[1;92m Account Logged in Successfully\x1b[1;97m ')
    print('-------------------------------------------')
    delay = int(input(' [+] DABBANG KI BH3N S4NVI  CHODNA CH4LU : '))
    print('-------------------------------------------')
    lnk = input(' [+] DABBANG KI BH39 S4NVI  KI CHUT MAI LINK DAL  / Link id : ')
    print('-------------------------------------------')
    lim = int(input(' [+] DABBANG KI R49D1 BH3N Repeat : '))
    print('-------------------------------------------')
    hater = input(' [+] DABBANG KI RANDI BHEN J4B T4K N4 CHOD JY3  : ')
    print('-------------------------------------------')
    filee = input(' [+] File : ')
